<!DOCTYPE html>
<html lang="en">
    <!-- Mirrored from creazione.avanzare.co/gravity/demo/index.html?bg=waves by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Feb 2024 14:04:45 GMT -->
    <head>
        <meta charset="utf-8" />
        <meta name="robots" content="noodp" />
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" />
        <title>Avascent | Coming Soon</title>
                    ...
                    <div class="container-mid">
                        ...
                        <div class="cycle-wrapper">
                            <div id="cycle">
                                <div class="slide">
                                    <h1>
                                        CRAFTING MILES<span> TO </span><br />
                                        SERVE YOU<br />
                                        BETTER.
                                    </h1>
                                </div>
                    ...
                    <div id="about" class="content">
                        <div class="container-mid">
                            <div class="container">
                                ...
                                <form action="https://creazione.avanzare.co/gravity/demo/assets/php/subscribe.php" method="post" class="subscribe-form">
                                    <div class="row">
                                        <div class="col-lg-12">
                                ...
                                <ul class="social-icons">
                                    <li>
                                        <a data-placement="bottom" title="Facebook" class="ti-facebook" href="#"><div class="overlay"></div></a>
                                    </li>
                                    <li>
                                        <a data-placement="bottom" title="Twitter" class="ti-twitter-alt" href="#"><div class="overlay"></div></a>
                                    </li>
                                    <li>
                                        <a data-placement="bottom" title="Google+" class="ti-google" href="#"><div class="overlay"></div></a>
                                    </li>
                                    <li>
                                        <a data-placement="bottom" title="Contact" class="fa fa-envelope go-down" href="#"><div class="overlay"></div></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <!-- Mirrored from creazione.avanzare.co/gravity/demo/index.html?bg=waves by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Feb 2024 14:04:47 GMT -->
</html>
